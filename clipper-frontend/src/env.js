...
export const env = createEnv({
  ...
  server: {
    ...
    NODE_ENV: z
      ...
      .default("development"),
    AWS_ACCESS_KEY_ID: z.string().min(20).max(20),
    AWS_SECRET_ACCESS_KEY: z.string().min(40).max(40),
    S3_BUCKET_NAME: z.string().min(3).max(63),
    S3_REGION: z.string().min(2).max(20),
